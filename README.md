...
```text
11408_2027 / 22408 考研备考总库
├── 101 思想与政治/            # 马原、毛中特、史纲、思修法基、时政热点复习体系
├── 201 数学(一)/              # 考研数学复习体系 (302数二主线 + 数一专属归档)
│   ├── 高等数学/              # 高数全章节标准化笔记、精选题解、课后精练、强化专题与出版级PDF
│   ├── 线性代数/              # 行列式、矩阵、向量组、方程组、特征值、二次型深度笔记
│   ├── [仅数学一]概率论/       # 概率论与数理统计全11章精选笔记 (数二不考，保留参考)
│   └── code/                 # KaTeX出版级PDF离线导出引擎、自动化构建与排版自检脚本
├── 301 英语(一)/              # 考研英语真题精读、核心高频词汇、语法长难句解析
